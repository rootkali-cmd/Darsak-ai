...
class _QrScreenState extends State<QrScreen> {
  ...
  Future<void> _loadQr() async {
    ...
    try {
      ...
      if (teacherId == null || teacherId.isEmpty) {
        setState(() {
          _error = 'لم يتم تحميل بيانات المعلم';
          _isLoading = false;
        });
        return;
      }
      final data = await _api.generateQR(teacherId);
      if (!mounted) return;
      setState(() {
        _qrData = data;
        _isLoading = false;
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isLoading)
            ...
            _buildQrContent(textPrimary, textSecondary, surfaceColor, borderColor),
          ...
          if (_qrData != null) ...[
            ...
            Center(
              child: TextButton.icon(
                ...
                label: const Text('تحديث QR Code'),
              ),
            ),
          ],
        ],
  ...
  Widget _buildQrContent(Color textPrimary, Color textSecondary, Color surfaceColor, Color borderColor) {
    final qrBase64 = _qrData!['qr_base64'] as String;
    final teacherCode = _qrData!['teacher_code'] as String;
    final base64Str = qrBase64.contains(',') ? qrBase64.split(',').last : qrBase64;
