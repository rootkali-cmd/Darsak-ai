  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<UpdateService>(
      builder: (context, update, _) {
        ...
        if (update.status == UpdateStatus.restartRequired) {
          return AlertDialog(
            backgroundColor: surfaceColor,
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                ...
                Text('يرجى إعادة تشغيل التطبيق', style: TextStyle(color: textSecondary)),
              ],
            ),
            actions: [
              TextButton(
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text('يمكنك متابعة العمل أثناء التحميل',
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text('سيتم إغلاق التطبيق تلقائياً', style: TextStyle(color: textSecondary)),
              ],
            ),
          );
        }
            ...
            content: Column(
              ...
              children: [
                ...
                if (update.errorDetail != null) ...[
                  const SizedBox(height: 8),
                  Text(update.errorDetail!, style: TextStyle(color: textSecondary, fontSize: 12)),
                ],
              ],
            ),
            actions: [
        ...
        if (update.status == UpdateStatus.available && info.mandatory) {
          return AlertDialog(
            backgroundColor: surfaceColor,
            content: Column(
              mainAxisSize: MainAxisSize.min,
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.system_update, color: AppTheme.danger, size: 24),
                    ),
                ...
                if (info.changelog.isNotEmpty) ...[
                  ...
                  ...info.changelog.map((item) => Padding(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('• ', style: TextStyle(color: AppTheme.danger, fontSize: 13)),
