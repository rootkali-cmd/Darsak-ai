...
CHANNELS: dict[str, dict[str, dict]] = {
    "stable": {
        ...
        "android": {
            ...
            "sha256": None,
            "changelog": [
                "تحديث توقيع APK (keystore جديد)",
                "تحسين صفحة الدفع - توجيه لصفحة الاشتراكات",
                "إصلاحات عامة وتحسين الأداء",
            ],
            "changelog_en": [
                "Updated APK signing key (new keystore)",
                "Improved pricing page - redirects to subscription page",
                "General fixes and performance improvements",
            ],
            "download_url": "https://github.com/rootkali-cmd/Darsak-ai/releases/download/v1.0.0/DarsakAI-Student-v1.2.1+4-universal.apk",
            "size_mb": 82,
            "release_date": "2026-05-26",
        },
        "accounts": {
