...
const apps: {
  ...
  },
  {
    ...
    color: '#FF6B00',
    files: [
      { name: 'DarsakAI-Teacher-v1.2.4.apk', label: 'Android APK v1.2.4', size: '~34 MB' },
    ],
    platform: 'Android 10+ ✓',
    note: 'إصدار 1.2.4 • 60s timeout • Friendly errors • Light/Dark • Sky Blue theme • minSdk=29',
  },
  {
    id: 'desktop',
