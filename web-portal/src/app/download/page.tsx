...
const apps: {
...
}[] = [
  {
    ...
    platform: 'Android ✓',
    note: 'أحدث إصدار • مساعد AI ذكي • Camera only permission',
  },
  {
    id: 'teacher',
    ...
    platform: 'Android ✓',
    note: 'أحدث إصدار • Barcode Scanner • Sound Effects • Recurring Sessions • Login system',
  },
  {
    id: 'desktop',
    ...
    platform: 'Windows ✓',
    note: 'أحدث إصدار • Offline-first • SQLite • Auto-sync • QR + PIN',
  },
]
