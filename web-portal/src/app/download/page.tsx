...
const apps: {
  ...
  },
  {
    ...
    color: '#FF6B00',
    files: [
      { name: 'DarsakAI-Teacher-v1.2.2.apk', label: 'Android APK v1.2.2', size: '~34 MB' },
    ],
    platform: 'Android 10+ ✓',
    note: 'إصدار 1.2.2 • Barcode Scanner • Light/Dark Theme • Working Settings • Real Error Messages • minSdk=29',
  },
  {
    id: 'desktop',
