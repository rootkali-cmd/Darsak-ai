...
const apps: {
  ...
  },
  {
    ...
    color: '#FF6B00',
    files: [
      { name: 'DarsakAI-Teacher-v1.2.5.apk', label: 'Android APK v1.2.5', size: '~70 MB' },
    ],
    platform: 'Android 10+ ✓',
    note: 'إصدار 1.2.5 • Server wake-up • Token refresh • 60s timeout • Light/Dark • minSdk=29',
  },
  {
    id: 'desktop',
