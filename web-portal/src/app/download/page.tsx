...
const apps: {
  ...
  },
  {
    ...
    color: '#FF6B00',
    files: [
      { name: 'DarsakAI-Teacher-v1.2.3.apk', label: 'Android APK v1.2.3', size: '~34 MB' },
    ],
    platform: 'Android 10+ ✓',
    note: 'إصدار 1.2.3 • Barcode Scanner • Light/Dark Theme • Working Settings • Auto-logout on 401 • Friendly Errors • minSdk=29',
  },
  {
    id: 'desktop',
