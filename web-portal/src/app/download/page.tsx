...
const apps: {
  ...
  },
  {
    ...
    color: '#FF6B00',
    files: [
      { name: 'DarsakAI-Teacher-v1.2.9.apk', label: 'Android APK v1.2.9', size: '~71 MB' },
    ],
    platform: 'Android 10+ ✓',
    note: 'إصدار 1.2.9 • إصلاح Not authenticated في كل الصفحات',
  },
  {
    id: 'desktop',
